...
Firstly, consistent formatting improves code readability. This means using consistent indentation, spacing, line breaks, punctuation, and naming conventions. Consider this block of code:
...
What on earth does it do? This thing is tough to look at, difficult to read, and frankly, just frustrating. It's filling my brain with frictional pain of having to keep track of what each variable represents and how they relate to each other. But while doing that, I need to grapple with the layout, the mixed naming, the inconsistent use of whitespace, and the overall lack of structure.
...
Not my cup of tea, but it is easier to manually format than the original, I guess. Although, someone else prefers this:
